...
//test
const genesisBlock = new Block(0, "", 9568754, "Anas");
...
//     console.log(calcHash(0, '' ,'7.333',"Anas"));
...
const IsBlockChainValid = (GetBlockChain) => {
  if (calcBlockHash(GetBlockChain()[0]) === calcHash(0, "", 9568754, "Anas")) {
...
*/
const newBlock = CreateNewBlock("Anas Shublaq");
newBlock.data = "Anas Shublaq";
